...
# Ejercicio 4
# Enunciado con Modificación en Tiempo de Ejecución (Clases): 
# Define una clase con un método. 
# Crea algunas instancias de esta clase. 
# Luego, en tiempo de ejecución, agrega un nuevo método a la clase. 
# Demuestra cómo este nuevo método se vuelve accesible 
# para todas las instancias de la clase, 
# incluyendo las que se crearon antes de la modificación.
