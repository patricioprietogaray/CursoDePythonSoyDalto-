...
# Ejercicio 2
# Enunciado Intermedio (Duck Typing): 
# Define dos clases diferentes, 
# cada una con un método que tiene el mismo nombre pero realiza acciones distintas. 
# Crea una función que tome un objeto como argumento y 
# llame a este método por su nombre. 
# Demuestra cómo la función puede trabajar con instancias de ambas 
# clases sin necesidad de conocer sus tipos explícitos de antemano, 
# gracias al enlace dinámico.
