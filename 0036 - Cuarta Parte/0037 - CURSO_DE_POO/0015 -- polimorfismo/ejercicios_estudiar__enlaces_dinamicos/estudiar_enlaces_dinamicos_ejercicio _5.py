...
# Ejercicio 5
# Enunciado Complejo (Reflexión): 
# Define una clase con varios métodos y atributos. 
# Escribe una función que tome un objeto de esta clase como 
# argumento. 
# Dentro de la función, utiliza las funciones getattr() y hasattr() 
# para inspeccionar el objeto en tiempo de ejecución:

#   Verifica si el objeto tiene un atributo específico 
# (cuyo nombre se pasa como cadena a la función). 
# Si lo tiene, imprime su valor.

#   Verifica si el objeto tiene un método específico 
# (cuyo nombre también se pasa como cadena). 
# Si lo tiene, llama a ese método.
